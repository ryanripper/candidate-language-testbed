...
2. **Visit tweets.** The generator files "toured the plant / stopped by the school" under the venue's *policy* topic; the LLM (both taxonomy runs, independently) saw a coherent `community-visits` genre — 12,523 tweets spread across every policy topic.
